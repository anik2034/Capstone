...
public class WishlistViewModel extends BookListViewModel {
    ...
    @Inject
    public WishlistViewModel(ResourceHelper resourceHelper, BookDatabase bookDatabase) {
        super(resourceHelper, bookDatabase);
    }

    @Override
    public void loadBooks() {
        List<BookModel> bookModelList = super.bookDao.getBooksByListType(ListType.WISHLIST);
